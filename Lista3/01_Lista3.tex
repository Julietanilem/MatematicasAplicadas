...
Supongamos que un cojinete de bolas de acero se suelta dentro de una tina de fluido y comienza a hundirse. Según un modelo, la velocidad $v(t)$ (en $m/s$) del rodamiento de bolas t segundos después de su liberación viene dada por la fórmula
\[
...
Para $t$ fijo, determine el valor límite de la velocidad como $k\rightarrow 0^+$ y dé una interpretación física del límite.
